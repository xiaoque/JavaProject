...
public class Service2 extends JApplet{
	//the variable that do operate to bank
	 ...
	 // Buttons
	  ...
	  public Service2() throws ParserConfigurationException, SAXException, IOException{
	  ...
	  public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		  JFrame frame = new JFrame("bank of the applet");
		  Service2 applet = new Service2();
